    ...
    public void Write(int a, int v)
    {
        ...
        switch (a)
        {
            ...
            case 0x2104:
                ...
                if (OamAddr < 0x200 && (OamAddr & 1) == 1)
                {
                    _oam[OamAddr - 1] = OamLatch;
                    _oam[OamAddr++] = (byte)v;
                    break;
                }
                else if (OamAddr > 0x1ff)
                    _oam[OamAddr % _oam.Length] = (byte)v;
                OamAddr++;
                break;
            case 0x2105:
                BgMode = v & 7;
            ...
            case 0x2122:
                ...
                {
                    _cram[CGADD & 0xff] = (ushort)((v & 0x7f) << 8 | _cgBuffer);
                    CGADD = (CGADD + 1) & 0xff;
                }
