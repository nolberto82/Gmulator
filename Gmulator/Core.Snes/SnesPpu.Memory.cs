    ...
    public byte Read(int a)
    {
        ...
        switch (a)
        {
            ...
            case >= 0x2300 and <= 0x23ff:
                v = Snes.Sa1?.ReadRegister(a) ?? 0;
                return v;
            case >= 0x3000 and <= 0x3fff:
                v = (byte)(Snes.Sa1?.ReadIram(a) ?? 0);
                return v;
        }
        return 0x00;
    }
    ...
    public void Write(int a, byte v)
    {
        ...
        switch (a)
        {
            ...
            case <= 0x2183:
                ...
                break;
            case >= 0x2200 and <= 0x22ff: Snes.Sa1?.WriteSnesRegister(a, v); break;
