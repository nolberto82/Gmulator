...
{
	//Opcodes
	public const int RRA = 0x00;
	public const int TAY = 0x01;
	public const int CLV = 0x02;
	public const int PLA = 0x03;
	public const int TYA = 0x04;
	public const int DEC = 0x05;
	public const int SED = 0x06;
	public const int ASR = 0x07;
	public const int CPX = 0x08;
	public const int BPL = 0x09;
	public const int BNE = 0x0A;
	public const int BIT = 0x0B;
	public const int NOP = 0x0C;
	public const int AAX = 0x0D;
	public const int SLO = 0x0E;
	public const int SYA = 0x0F;
	public const int BEQ = 0x10;
	public const int LDY = 0x11;
	public const int CLD = 0x12;
	public const int SXA = 0x13;
	public const int AXS = 0x14;
	public const int TXA = 0x15;
	public const int CLC = 0x16;
	public const int ORA = 0x17;
	public const int SRE = 0x18;
	public const int AND = 0x19;
	public const int RLA = 0x1A;
	public const int DEX = 0x1B;
	public const int LAX = 0x1C;
	public const int ROL = 0x1D;
	public const int TXS = 0x1E;
	public const int CPY = 0x1F;
	public const int PHA = 0x20;
	public const int ISB = 0x21;
	public const int ADC = 0x22;
	public const int AXA = 0x23;
	public const int CMP = 0x24;
	public const int SEI = 0x25;
	public const int DEY = 0x26;
	public const int LDX = 0x27;
	public const int LAR = 0x28;
	public const int ROR = 0x29;
	public const int ARR = 0x2A;
	public const int ATX = 0x2B;
	public const int TAX = 0x2C;
	public const int JMP = 0x2D;
	public const int XAS = 0x2E;
	public const int LDA = 0x2F;
	public const int INX = 0x30;
	public const int STA = 0x31;
	public const int BMI = 0x32;
	public const int BCC = 0x33;
	public const int PHP = 0x34;
	public const int BRK = 0x35;
	public const int INC = 0x36;
	public const int STX = 0x37;
	public const int TSX = 0x38;
	public const int JSR = 0x39;
	public const int RTS = 0x3A;
	public const int INY = 0x3B;
	public const int RTI = 0x3C;
	public const int CLI = 0x3D;
	public const int DCP = 0x3E;
	public const int PLP = 0x3F;
	public const int STY = 0x40;
	public const int SEC = 0x41;
	public const int XAA = 0x42;
	public const int BVS = 0x43;
	public const int SBC = 0x44;
	public const int LSR = 0x45;
	public const int BCS = 0x46;
	public const int ASL = 0x47;
	public const int BVC = 0x48;
	public const int EOR = 0x49;
	public const int KIL = 0x4A;
	public const int ANC = 0x4B;
	public const int TOP = 0x4C;
	...
	public struct Opcode(string name, int id, int mode, int size, int cycles, int extracycle)
    {
